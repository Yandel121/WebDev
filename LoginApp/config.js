...
const config = {
    user: process.env.DB_USER || 'Colon', // Username from .env
    password: process.env.DB_PASSWORD || 'Bambam', // Password from .env
    server: process.env.DB_SERVER || 'localhost\\SQLEXPRESS', // SQL Server instance
